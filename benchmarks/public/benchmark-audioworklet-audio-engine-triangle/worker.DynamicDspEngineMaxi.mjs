...
class DynamicDspEngineMaxiNode extends BenchmarkProcessor {
    
    constructor(options) {
        super(options)

        const dspModule = this.dspModule = DynamicDspEngineMaxi()
...
registerProcessor("benchmark-processor", DynamicDspEngineMaxiNode)